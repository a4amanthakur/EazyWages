...
if (isset($_POST["upload"])) {
    $upl = new clsadmin();
    $upl->catname = $_POST["name"];
    $upl->catimg = $_FILES["catimage"]["name"];
    $res = $upl->upload_category();
    ...
    if ($res == TRUE) {
        ...
        echo "<script> alert ('Data not upload successfully...');</script>";
    }
}

if (isset($_REQUEST["delid"])) {
    $obj = new clsadmin();
    $obj->cod = $_REQUEST["delid"];
    $res = $obj->del_cat();
    if ($res == TRUE) {
...
if (isset($_POST["update"])) {
    $obj = new clsadmin();
    $obj->cod = $_SESSION["cod"];
    // echo $_SESSION["cod"];
    $obj->cat = $_POST["name"];

    $obj->cat_pic = $_POST["pic"];
    $res = $obj->update_cat();
    /* if ($_FILES["pic"]["name"] != "") {
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="upload_tehsil.php"  style="font-size: 15px;">Upload City</a>
                        </li>
        ...
        <div class="content-part">
            <div class="container">
                <div class="login-form">
                    <form  name="state" action="admin_upload_data.php" method="POST" enctype="multipart/form-data">
                        <h1>Upload Category</h1>
                        <hr>
                        <label for="name">Name</label>
                        <input type="text" id="name" required name="name" placeholder="Enter Category name" class="form-control">
                        <br>
                        <label for="img">Choose Photo</label>
                        <input type="file" id="img" required name="catimage" class="form-control" >
                        <br><Br>
            ...
            <div class="container">
                <form name="table" action="admin_upload_data.php" method="POST">
                    <center>
                        <table>
                            <caption><h1>Uploaded Categories</h1></caption>
                            <thead>
                            <th>ID</th>
                            <th>Category</th>
                            <th>Images</th>
                            ...
                            <tbody>
                                ...
                                if (!isset($_REQUEST["eid"])) {
                                    ...
                                    while ($r = mysqli_fetch_row($res)) {
                                        ...
                                        /* echo "<tr>"
                                          ...
                                          . "<td>";
                                          echo "<a href='admin_upload_data.php?eid=$r[0]'>Edit</a> |";
                                          echo "<a href='admin_upload_data.php?delid=$r[0]'>Delete</a>"
                                          . " </td>"
                                          . "</tr>"; */
                                        echo '<tr>';
                                        echo '<td>' . $cod . '</td>';
                                        ...
                                        echo '<td><a href=admin_upload_data.php?eid=' . $cod . '>Edit</a></td>';
                                        echo '<td><a href=admin_upload_data.php?delid=' . $cod . '>Delete</a></td>';
                                ...
                                if (isset($_REQUEST["eid"])) {
                                    ...
                                    $cod = $_REQUEST["eid"];
                                    $link = $con->dbconnect();
                                    $qry = "CALL fetch_cat_id($cod)";
                                    $res = mysqli_query($link, $qry);
                                    while ($r = mysqli_fetch_row($res)) {
                                        $_SESSION["cod"] = $r[0];
                                        echo "<tr>";

                                        echo "<td><input readonly type='text' name='cod' value='$r[0]'> </td>";
                                        echo "<td><input type='text' name='name' value='  $r[1]  '></td>";
                                        echo "<td><input type='file' name='pic' value='  $r[2]  '></td>";
