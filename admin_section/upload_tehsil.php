...
if (isset($_POST["upload"])) {
    $upl = new clsadmin();
    $upl->country = $_POST["country"];
    $upl->phcode = $_POST["cod"];
    $res = $upl->country();
    if ($res == TRUE) {
...
if (isset($_REQUEST["delid"])) {
    $del = new clsadmin();
    $del->cod = $_REQUEST["delid"];
    $res = $del->delete_country();
    if ($res == TRUE) {
        echo "<script>alert ('Country Delete Successfully...')</script>";
    } else {
...
if (isset($_POST["update"])) {
    ...
    $upd = new clsadmin();
    $upd->cod = $_POST["dcod"];
    $upd->country = $_POST["name"];
    $upd->phcode = $_POST["cod"];
    $res = $upd->update_country();
    if ($res == TRUE) {
        ...
        <div class="content-part">
            <div class="container">
                <div class="login-form">
                    <form  name="distt" action="upload_tehsil.php" method="POST">
                        <h1>Upload Country</h1>
                        <hr>
                        <label for="cntry">Enter Country name</label>
                        <input type="text" id="cntry" required name="country" class="form-control">
                        <label for="code">
                            Phone code
                        </label>
                        <input type="text" name="cod" id="code" class="form-control">
                        <br><Br>
            ...
            <div class="container">
                <form name="table" action="upload_tehsil.php" method="POST">
                    <center>
                        <table>
                            <caption><h1>Uploaded Countries</h1></caption>
                            <thead>
                            <th>Country Code</th>
                            <th>Country Name</th>
                            <th>Phone code</th>
                            ...
                            <tbody>
                                ...
                                if (!isset($_REQUEST["eid"])) {
                                    ...
                                    $qry = "CALL fetch_country_by_id_in_desc()";
                                    ...
                                    while ($r = mysqli_fetch_row($res)) {
                                        if ($i < 11) {
                                            ...
                                            $name = $r[2];
                                            $phcode = $r[3];
                                            echo "<tr><td>$cod</td><td>$name</td><td>$phcode</td><td><a href='upload_tehsil.php?eid=$r[0]'>Edit</a> | <a href='upload_tehsil.php?delid=$r[0]'>Delete</a> </td></tr>";
                                        }
                                        $i++;
                                    }
                                } else {
                                    if (isset($_REQUEST["eid"])) {
                                        ...
                                        while ($r = mysqli_fetch_row($res)) {
                                            ...
                                            echo "<td>";
                                            echo '<input type="text" name="name" value=' . $r[2] . '>';
                                            echo "</td>";
                                            echo "<td><input type='text'  name='cod' value='$phcod'></td>";
